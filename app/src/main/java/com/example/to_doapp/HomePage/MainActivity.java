...
public class MainActivity extends AppCompatActivity {
  ...
  public static List<TaskModel> addTasks() {
    ...
    // if (taskList.isEmpty()) animationView.setVisibility(
    //   View.VISIBLE
      ...
      .addSnapshotListener(
        new EventListener<QuerySnapshot>() {
          ...
          public void onEvent(
            ...
            // Update the visibility of the animation view based on the task list size
            if (taskList.isEmpty()) {
...
class TimeComparator implements Comparator {
  ...
  public int compare(Object o1, Object o2) {
    ...
    try {
      ...
      if (d1.equals(d2)) return 0; else if (
        d1.before(d2)
